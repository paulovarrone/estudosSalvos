...
def main():
    ...
    # Define o tamanho da janela como ocupando toda a tela
    ...
    lista_estoque = tk.Listbox(root, font=("Arial", 13), height=32, width=100)
    lista_estoque.grid(row=4, column=0, columnspan=2, padx=20, pady=20, sticky="sn")
